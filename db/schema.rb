...
ActiveRecord::Schema.define(version: 20_150_621_005_306) do
  ...
  add_index 'repository_accesses', %w(user_id repository_id), name: 'index_repository_accesses_on_user_id_and_repository_id', using: :btree
